 ...
 */
function generateModule(promptDoc: PromptDocument): string {
...
import { registerHelpers } from '../../../src/prompts/handlebars-helpers.js';
  ...
  for (const relativePath of mdFiles) {
    ...
    try {
      ...
      if (promptDoc) {
        ...
        const moduleCode = generateModule(promptDoc);
